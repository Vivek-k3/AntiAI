...
export function Files() {
  return (
    <div>
      <Tabs
        defaultValue="images"
        className="w-[400px] mx-auto bg-background p-3 rounded-2xl shadow-[0px_4px_24px_0px_hsla(0,0%,0%,0.1)]"
      >
        <TabsList className="w-full h-auto p-1.5 border rounded-xl text-foreground">
          <TabsTrigger
            className="w-full px-5 py-3 rounded-lg border border-transparent data-[state=active]:border-primary-color"
            value="images"
          >
            Images
          </TabsTrigger>
  ...
  return (
    ...
    >
      ...
      <div className="pt-3 flex items-center justify-between gap-3">
        ...
        <Button
          className="w-full h-12 rounded-xl capitalize  bg-primary-color text-background"
          type="submit"
        >
          Upload {type}
        </Button>
...
function TextInput() {
  ...
  return (
    <form className="mx-3" onSubmit={handleSubmit}>
      <textarea
        className={cn(
          "border-2 relative z-50 hover:cursor-pointer rounded-xl h-64 inline-block w-full resize-none p-4 bg-muted"
        )}
      ...
      <div className="pt-1 flex items-center justify-between gap-3">
        ...
        <Button
          className="w-full h-12 rounded-xl bg-primary-color text-background"
          type="submit"
          disabled={text.length === 0}
        >
          Vefiry Text
